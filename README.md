...
1. This is an individual assignment; your work must be entirely your own.
2. You may use any course materials, but you may not discuss the exam with anyone other than the instructional staff.
3. Complete all of your work in `midterm1.qmd`; only the expected files may be committed to this repository.
4. Questions should be asked by opening an issue in this repository; the instructional staff will respond there.
